...
this.opts.style)},thumbnailConfig:function(){var a={},b=e('<div class="wowbook-thumbnail" style="display:none;position:absolute;line-height:0px;font-size:0px;">').prependTo(this.thumbnailsContainer),c=this.opts.thumbnailHeight||(2>=b.height()?0:b.height()),d=this.opts.thumbnailWidth||b.width(),g=d/this.pageWidth||c/this.pageHeight||this.opts.thumbnailScale;b.remove();this.thumbnailScale=g;a.width=d||Math.floor(this.pageWidth*g);a.height=c||Math.floor(this.pageHeight*g);a.cloneCSS={display:"block",
left:0,top:0,position:"relative",transformOrigin:"0 0"};e.wowBook.support.transform?a.cloneCSS.transform="scale("+g+")":a.cloneCSS.zoom=g;this.differentPageSizes&&(b=this.opts.pageWidth?g*this.pageWidth/this.opts.pageWidth:this.opts.pageHeight?g*this.pageHeight/this.opts.pageHeight:this.opts.thumbnailScale,a.scaleInternalPage=e.wowBook.support.transform?{transform:"scale("+b+")"}:{zoom:b});return a},createThumbnail:function(a,b){var c=this.pages[a];if(c){b||(b=this.thumbnailConfig());var d=e('<li class="wowbook-thumbnail"><div class="wowbook-overlay">').addClass(this.pageIsOnTheLeft(a)?
"wowbook-left":"wowbook-right").css({width:b.width,height:b.height}),g=c.find(".wowbook-page-content");(g=g.data("thumb")||g.data("thumbnail"))?(d.addClass("wowbook-thumbnail-custom"),d.src=g):this.opts.thumbnailsSprite?d.css("background",'url("'+this.opts.thumbnailsSprite+'") no-repeat 0px -'+a*b.height+"px"):this.opts.thumbnailsImages?d.addClass("wowbook-thumbnail-custom"):(g=c.clone(),g.hasClass("wowbook-page-holded")&&(this.resetPage(g),g.find(".wowbook-fold-gradient-container").remove()),g.css(b.cloneCSS),
b.scaleInternalPage&&!c.isCover&&g.css(b.scaleInternalPage),d.prepend(g));var f=this;d.click(function(){f.gotoPage(a);f.hideThumbnails()});return d}},updateThumbnail:function(a,b){if(this.thumbnails){var c=this.thumbnails[a];if(c){var d=this.createThumbnail(a,b);if(d){c.width(d.width());c.height(d.height());if(!this.opts.thumbnailsSprite)if(this.opts.thumbnailsImages||c.src){var e=c.src||this.thumbnailImageSrc(a);if(c.loadedImage!=e){c.addClass("wowbook-loading");var f=new Image;f.onload=function(){c.removeClass("wowbook-loading");
c.css("background-image",'url("'+e+'")');c.loadedImage=e};f.src=e}}else this.pdfDoc?this.pdfRenderThumbnail(a,c,b):c.children(":not(.wowbook-overlay)").replaceWith(d.children(":not(.wowbook-overlay)"));c.width(d.width());c.height(d.height())}}}},updateThumbnails:function(){if(this.thumbnails){for(var a=this.thumbnailConfig(),b=0,c=this.pages.length;b<c;b++)this.updateThumbnail(b,a);b=this.thumbnailsContainer;b.width()||b.width(2*a.width);this.thumbnailsContainer.toggleClass("wowbook-closable",this.closable)}else this.createThumbnails()},
thumbnailImageSrc:function(a){if(!(0>a||a>this.pages.length-1))return this.replaceNumberHolder(this.opts.thumbnailsImages,a)},_moveThumbnailsList:function(a,b){var c=this.thumbnailsList.position()[this.opts.thumbnailsVertical?"top":"left"];this._setThumbnailsListPosition(c+a,b)},_setThumbnailsListPosition:function(a,b){var c=this.opts.thumbnailsVertical,d=c?"height":"width",g=this.thumbnailsClipper[d]();d=-this.thumbnailsList[d]()+g;a<d&&(a=d);0<a&&(a=0);this.thumbnailsBackButton.toggleClass("wowbook-disabled",
0==a||0<d);this.thumbnailsNextButton.toggleClass("wowbook-disabled",a==d||0<d);void 0==b&&(b=e.extend({},this.opts.thumbnailsAnimOptions));var f=this;e.isNumeric(b)&&(b={duration:b});b.step=c?function(a){f.thumbnailsClipper.scrollTop(a)}:function(a){f.thumbnailsClipper.scrollLeft(a)};b.complete=function(){(f.pdfDoc||f.opts.thumbnailsImages||f._customThumbnail)&&f.updateVisibleThumbnails()};this._tb=this.thumbnailsClipper[c?"scrollTop":"scrollLeft"]();e(this).stop();e(this).animate({_tb:-a},b)},updateVisibleThumbnails:function(){var a=
this.opts.thumbnailsVertical,b=a?"top":"left",c=a?"height":"width";if(!this._thumbnailsPos)for(this._thumbnailsPos=[],a=0;a<this.thumbnails.length;a++)this._thumbnailsPos[a]=this.thumbnails[a].position()[b];var d=this._thumbnailsPos;b=-this.thumbnailsList.position()[b];c=b+this.thumbnailsClipper[c]();var e,f;for(a=0;a<this.thumbnails.length;a++)void 0==e&&d[a]>b&&(e=a),void 0==f&&d[a]>c&&(f=a);e||(e=0);f||(f=this.thumbnails.length-1);this.pdfDoc&&(this.pdfCancelRenderThumbnail(0,e),this.pdfCancelRenderThumbnail(f,
this.thumbnails.length));for(a=e-2;a<=f;a++)this.updateThumbnail(a)},showThumbnail:function(a,b){if(this.thumbnails&&this.thumbnailsContainer.is(":visible")){void 0==a&&(a=this.currentPage);0<a&&this.pageIsOnTheRight(a)&&a--;var c=this.opts.thumbnailsVertical,d=c?"top":"left",e=c?"height":"width",f=this.thumbnails[a],h=this.thumbnailsClipper;c=h[e]()/2-f[e]()/(c?2:1);d=f.offset()[d]-h.offset()[d];this._moveThumbnailsList(c-d,b)}},showThumbnails:function(a){this.thumbnails&&this.thumbnails.length||
this.createThumbnails();this.thumbnailsContainer.fadeIn(void 0!=a?a:this.opts.thumbnailsAnimOptions);this.showThumbnail(void 0,0)},hideThumbnails:function(a){this.thumbnailsContainer.fadeOut(void 0!=a?a:this.opts.thumbnailsAnimOptions)},toggleThumbnails:function(a){e(this.thumbnailsContainer).is(":visible")?this.hideThumbnails(a):this.showThumbnails(a)},setPDF:function(a){this.pdf=a;this.pdfRenderQueue=[];this.pdfPageRendering=!1;this.opts.zoomUsingTransform=!0;this.zoomContent.css("zoom",1);1!=this.currentScale&&
this.scale(this.currentScale);this.elem.addClass("wowbook-pdf");this.removePages();null==this.opts.pagesInMemory&&(this.opts.pagesInMemory=6);var b=this;this.pdfCSS_UNITS=96/72;b.opts.pdfTextSelectable&&this.zoomContent.css("-webkit-user-select","text");PDFJS.cMapPacked=this.opts.pdfcMapPacked;PDFJS.cMapUrl=this.opts.pdfcMapUrl;PDFJS.getDocument(a).then(function(a){b.pdfDoc=a;b.currentPage=b.startPage;a.getPage(1).then(function(c){for(var d=0;d<a.numPages;d++)b.insertPage("<div>",!0);b.opts.pdfFind&&
b.pdfFindSetup();b.pdfBuildLinkService();b._pdfFindController&&b._pdfFindController.resolveFirstPage();b.opts.toc||b.pdfOutline();b.updateBook(!0);c=c.getViewport(1*b.pdfCSS_UNITS*b.opts.pdfScale);b.pdfHeight=c.height;b.pdfWidth=c.width;b.pdfViewport=c;b._originalHeight=null;b._originalWidth=null;b.setDimensions(2*b.pdfWidth,b.pdfHeight);1!=b.opts.zoomLevel&&b.zoom(b.opts.zoomLevel,{duration:0})})},b.opts.onPDFLoadError||function(a){e(b.pages[0]||b.elem).html(a.message);console&&console.log&&console.log(a)})},
pdfBuildLinkService:function(){var a=this;this.pdfLinkService={navigateTo:function(){a.pdfNavigateTo.apply(a,arguments)},getDestinationHash:function(a){return this.getAnchorUrl("")},getAnchorUrl:function(a){return a}};return this._pdfLinkService},pdfResetPages:function(){this.updateBook(!0);for(var a=0;a<this.pages.length;a++)this.unloadPage(this.pages[a]);a=this.opts.pdfUpdateRender;this.opts.pdfUpdateRender=!1;this._reponsiveApplied?this.elem.trigger("resize"):this.opts.scaleToFit&&this.scaleToFit();
this.showPage(this.currentPage);this.opts.pdfUpdateRender=a;this.positionBookShadow()},pdfLoadPage:function(a,b){var c=e("<canvas>");this.opts.pdfProgressiveRender&&c.appendTo(this.pages[a].find(".wowbook-page-content"));this.pdfRenderPage(a,c[0],this.finishPageLoading)},pdfRenderPage:function(a,b,c,d,g){if(this.pdfPageRendering)this.pdfQueueRenderPage(a,b,c,d,g);else{this.pdfPageRendering=!0;var f=this;this.pdfDoc.getPage(a+1).then(function(h){d||(d=f.pdfFindScaleToFit());var k=h.getViewport(d*f.pdfCSS_UNITS*
f.opts.pdfScale),l=f.pages[a],m=!1,n=!1;if(f.opts.pdfUpdateRender&&"thumb"!=g){var q=f.currentScale*f.zoomLevel*f.opts.pdfPixelRatio;k=l.pageWidth*q;var r=h.getViewport(1);k=h.getViewport(k/r.width);b?e(b).addClass("wowbook-pdf-zoom-"+q).css({transform:"scale("+1/q+")","transform-origin":"0 0 0"}):(b=l.find(".wowbook-pdf-zoom-"+q),n=b.length,b.length||(b=e("<canvas>").addClass("wowbook-pdf-zoom-"+q),b.css({transform:"scale("+1/q+")","transform-origin":"0 0 0"}),m=!0),b=b[0])}n||(b.height=k.height,
b.width=k.width);q={canvasContext:b.getContext("2d"),viewport:k};k=function(){m&&!e(b).parent().length&&e(b).appendTo(l.find(".wowbook-page-content"));c&&c.call(f,f.pages[a],b);if("thumb"!=g){l.find("canvas").not(b).remove();var d=h.getViewport(1*f.pdfCSS_UNITS*f.opts.pdfScale);d=h.getViewport(f.pdfWidth/d.width*f.pdfCSS_UNITS*f.opts.pdfScale);if(!l.find(".wowbook-pdf-annotations").length){var k=e('<div class="wowbook-pdf-annotations">').appendTo(l.find(".wowbook-page-content"));f.pdfAnnotations(h,
d,k)}f.opts.pdfTextSelectable&&!l.textLayer&&"thumb"!=g&&f.pdfTextLayer(h,a,d)}f.pdfPageRendering=!1;f.pdfDequeueRenderPage()};n?k():h.render(q).then(k,function(){})})}},pdfUpdateRender:function(a){if(this.opts.pdfUpdateRender){var b=this.pages[this.currentPage],c=this.otherPage(this.currentPage);b&&this.pdfRenderPage(b.pageIndex,void 0,a);void 0!=c&&this.pdfRenderPage(c,void 0,a)}},pdfAnnotations:function(a,b,c){var d=this;a.getAnnotations().then(function(e){b=b.clone({dontFlip:!0});PDFJS.AnnotationLayer.render({viewport:b,
div:c[0],annotations:e,page:a,linkService:d.pdfLinkService});c.find("a").attr("target","_blank")})},pdfTextLayer:function(a,b,c,d){if(!d){var g=this.pages[b];d=g.find(".wowbook-pdf-text");d.length||(d=e('<div class="wowbook-pdf-text">').appendTo(g.find(".wowbook-page-content")))}var f=new PDFJS.TextLayerBuilder({textLayerDiv:d[0],pageIndex:b,viewport:c,findController:this._pdfFindController});g.textLayer=f;a.getTextContent({normalizeWhitespace:!0}).then(function(a){f.setTextContent(a);f.render(PDFJS.TextLayerBuilder.TEXT_LAYER_RENDER_DELAY)})},
pdfNavigateTo:function(a){var b=this;b.pagesRefMap||(b.pagesRefMap={});var c=function(a){var d=a instanceof Object?b.pagesRefMap[a.num+" "+a.gen+" R"]:a+1;d?b.gotoPage(d-1):b.pdfDoc.getPageIndex(a).then(function(d){b.pagesRefMap[a.num+" "+a.gen+" R"]=d+1;c(a)})};("string"==typeof a?this.pdfDoc.getDestination(a):Promise.resolve(a)).then(function(a){a instanceof Array&&c(a[0])})},pdfRenderThumbnail:function(a,b,c){this.thumbnailsContainer.addClass("wowbook-pdf");if((c=this.pages[a])&&!c.loading&&!b.pdf&&
!b.rendering){b.rendering=!0;var d=b.find("canvas");d.length||(d=e("<canvas>").appendTo(b.find(".wowbook-page-content")));d.css("transform","");this.opts.pdfProgressiveRender||d.css("display","none");b.find(".wowbook-page").css({width:b.width(),height:b.height(),zoom:1,transform:"scale(1)"});this.pdfRenderPage(a,d[0],function(a,c){d.css("display","block");b.rendering=!1;b.pdf=!0;b.find(".wowbook-pdf-text, .wowbook-pdf-annotations").remove()},this.thumbnailScale*this.opts.pdfScale,"thumb")}},pdfCancelRenderThumbnail:function(a,
b){for(var c=this.pdfRenderQueue,d=0;d<c.length;){var e=c[d][0];e>=a&&e<=b&&"thumb"==c[d][4]?(this.thumbnails[e].rendering=!1,c.splice(d,1)):d++}},pdfQueueRenderPage:function(a,b,c,d,e){this.pdfRenderQueue.push([].slice.call(arguments))},pdfDequeueRenderPage:function(){var a=this.pdfRenderQueue.shift();a&&this.pdfRenderPage.apply(this,a)},pdfFindScaleToFit:function(){var a=this.pageWidth,b=this.pageHeight,c=this.pdfWidth/this.pdfHeight;b*c>a&&(b=a/c);return b/this.pdfHeight},pdfOutline:function(){var a=
this;this.pdfDoc.getOutline().then(function(b){function c(a){for(var b=[],d=0,e=a.length;d<e;d++){var k=[];k[0]=PDFJS.removeNullCharacters(a[d].title);k[1]=a[d].url;a[d].items&&a[d].items.length&&(k[2]=c(a[d].items));k[3]=a[d].dest;b.push(k)}return b}b&&(a.opts.toc=c(b),a.opts.displayToc&&a.showToc())})},pdfFindSetup:function(){this._pdfFindController||(this.opts.pdfTextSelectable=!0,this.createFindBar(),this.pdfCreateFindController(),this.setStrings())},pdfFind:function(){this.pdfSearch.apply(this,
arguments)},pdfFindNext:function(){var a=Array.prototype.slice.call(arguments);a[3]=!1;a[4]="again";this.pdfSearch.apply(this,a)},pdfFindPrevious:function(){var a=Array.prototype.slice.call(arguments);a[3]=!0;a[4]="again";this.pdfSearch.apply(this,a)},createFindControl:function(a,b){b||(b=this.opts);var c=this;e(a).addClass("wowbook-control-find").on("click.wowbook",function(a){if(!e(a.target).closest(".wowbook-findbar").length)return c.toggleFindBar(),!1})},toggleFindBar:function(a){a||(a=e(this._pdfFindBar));
a.hasClass("wowbook-hidden")?(a.css("opacity",0).removeClass("wowbook-hidden"),u(a)||a.toggleClass("wowbook-up"),a.css("opacity",1),a.find(".wowbook-find-text").focus()):a.addClass("wowbook-hidden")},createFindBar:function(){var a=e('<div id="findbar" class="wowbook-findbar wowbook-hidden"><label style="display:none">Find: </label><div class="wowbook-find-text-container"><input class="wowbook-find-text" placeholder="Text to find"><span class="wowbook-find-count"></span></div><a title="Find the previous occurrence of the phrase" class="wowbook-find-previous wowbook-control-back"><i></i><span>Previous</span></a><a title="Find the next occurrence of the phrase" class="wowbook-find-next wowbook-control-next"><i></i><span>Next</span></a><label style="display:none"><input type="checkbox" class="wowbook-find-highlight-all" checked="1"> Highlight all</label><label><input type="checkbox" class="wowbook-find-match-case"> <span>Match case</span></label><a class="wowbook-close"><i></i></a></div>').appendTo(e(this.toolbars[0]).find(".wowbook-controls"));
